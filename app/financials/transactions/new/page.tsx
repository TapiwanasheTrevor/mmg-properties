...
export default function NewTransactionPage() {
  ...
  // Check permissions
  const canCreateTransactions = ['admin', 'agent'].includes(user.role);
        ...
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center max-w-md">
            ...
            <p className="text-gray-600 mb-4">
              You don't have permission to create transactions. This action is restricted to 
    ...
    >
      <TransactionForm
        onSuccess={(transactionId) => {
          // Redirect to transaction details or back to list
          window.location.href = `/financials/transactions/${transactionId}`;
        }}
        onCancel={() => {
          window.location.href = '/financials/transactions';
        }}
      />
    </AppLayout>
  );
